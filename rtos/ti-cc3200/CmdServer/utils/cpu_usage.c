...
//
//*****************************************************************************
static uint32_t g_pui32CPUUsageTimerPeriph[4] =
{
		PRCM_TIMERA0, PRCM_TIMERA1, PRCM_TIMERA2, PRCM_TIMERA3
};
...
//
//*****************************************************************************
static uint32_t g_pui32CPUUsageTimerBase[4] =
{
    TIMERA0_BASE, TIMERA1_BASE, TIMERA2_BASE, TIMERA3_BASE
};
...
CPUUsageTick(void)
{
    ...
    // value.
    //
    ui32Usage = ((((g_ui32CPUUsagePrevious - ui32Value) * 1600) / g_ui32CPUUsageTicks) * 4 * 1024);
...
//*****************************************************************************
void
CPUUsageInit(uint32_t ui32Rate, uint32_t ui32Timer)
{
    //
    // Check the arguments.
    //
    ...
    //
        ...
        //
        // JMCG. Sustituido por lo de abajo MAP_SysCtlPeripheralEnable(g_pui32CPUUsageTimerPeriph[ui32Timer]);
        MAP_PRCMPeripheralClkEnable  ( g_pui32CPUUsageTimerPeriph[ui32Timer],PRCM_RUN_MODE_CLK); //JMCG clock gating en sleep
        //JMCG No necesario MAP_SysCtlPeripheralSleepDisable(g_pui32CPUUsageTimerPeriph[ui32Timer]);

    //
    // Determine the number of system clocks per measurement period.
    //
    g_ui32CPUUsageTicks = PRCMPeripheralClockGet ( g_pui32CPUUsageTimerPeriph[ui32Timer]) / ui32Rate;
    ...
    //
    //JMCG No necesario.... MAP_SysCtlPeripheralClockGating(true);
    ...
    MAP_TimerControlStall(g_pui32CPUUsageTimerBase[ui32Timer], TIMER_A,true);	//Depuracion
}
