...
UARTStdioConfig(uint32_t ui32PortNum, uint32_t ui32Baud)
{
	...
	//
	MAP_PRCMPeripheralClkEnable  ( g_ui32UARTPeriph[ui32PortNum],PRCM_RUN_MODE_CLK|PRCM_SLP_MODE_CLK ); //JMCG clock activo en sleep

	//
	// Configure the UART for 115200, n, 8, 1
	//
	MAP_UARTConfigSetExpClk(g_ui32Base, MAP_PRCMPeripheralClockGet(g_ui32UARTPeriph[ui32PortNum]), ui32Baud,
	...
	MAP_IntRegister(g_ui32UARTInt[ui32PortNum],UARTStdioIntHandler); //La tabla de vectores esta en RAM de todas formas...
