...
//
//*****************************************************************************
//!! Modificado por DTE para MSP430 y GCC---> sustituye parcialmente e stdlib (y es mas fiable, para más INRI)
#include <stdint.h>
...
//*****************************************************************************
char *
ustrncpy(char * __restrict__ s1, const char * __restrict__ s2, size_t n)
{
    size_t count;
...
//*****************************************************************************
int
uvsnprintf(char * __restrict__ s, size_t n, const char * __restrict__ format,
           va_list arg)
{
...
//*****************************************************************************
int
usprintf(char * __restrict__ s, const char * __restrict__ format, ...)
{
    va_list arg;
    int ret;
...
//*****************************************************************************
int
usnprintf(char * __restrict__ s, size_t n, const char * __restrict__ format, ...)
{
    va_list arg;
    int ret;
...
//*****************************************************************************
unsigned long
ustrtoul(const char * __restrict__ nptr, const char ** __restrict__ endptr, int base)
{
